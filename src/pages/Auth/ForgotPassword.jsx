...
const ForgotPassword = () => {
    ...
    const onEmailSubmit = async (e) => {
        ...
        try {
            const response = await axiosInstance.post(`${API_PATHS.AUTH.SEND_RESET_OTP}?email=` + email);
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            ...
            const respense = await axiosInstance.post(API_PATHS.AUTH.VERIFY_RESET_OTP, { email, otp });
    ...
    const onSubmitNewPassword = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await axiosInstance.post(`${API_PATHS.AUTH.RESET_PASSWORD}`, { email, newPassword });
            if (response.status === 200) {
